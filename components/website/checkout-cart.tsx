              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <div className=" pt-2">
                      <span className=" font-medium">Please Make payment and send us screenshot</span>
                      <Image
                        src={qrimage}
                        alt="qr"
                        width={500}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <div className=" flex  flex-col  gap-2">
                            ...
                            <>
                              {uploading ? (
                                <div className=" flex flex-col gap-2 rounded-md  justify-center h-96  w-full ">
                                  <LoaderSpin />
                                </div>
                              ) : (
                                <div>
                                  {imageUrl && (
                                    <Image
                                      ...
                                      src={imageUrl}
                                      alt="img"
                                      className="p-0.5 rounded-md overflow-hidden h-96  w-full   mx-auto"
                                    />
                                  )}
                                </div>
                              )}
