...
function SingleCategoryCard({ category }: any) {
  ...
  return (
    <>
      {category && (
        <div className="border   border-primary-50 rounded-xl p-2 w-9/12 md:w-full mx-auto text-primary-50 space-y-1 cursor-pointer  ">
          <Link href={`/shop?category=${category.name}`}>
            <Image
              ...
              width={400}
              height={400}
              className="productImage object-top sm:object-cover rounded-t-xl h-72 w-full "
